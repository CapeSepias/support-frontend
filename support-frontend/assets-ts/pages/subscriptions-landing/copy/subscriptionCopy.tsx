...
const orderedProducts = (state: State): ProductCopy[] => {
	...
	if (countryGroupId === GBPCountries) {
		return [
			...
			guardianWeekly(
				countryGroupId,
				state.page.pricingCopy[GuardianWeekly],
				false,
			),
			paper(countryGroupId, state.page.pricingCopy[Paper], false), // Removing the link to the old paper+digital page during the June 21 Sale
