...
function EditorialVoice() {
  return <FlexContainer cssOverrides={evFlexContainer}>
      ...
      <div css={evQuoteContainer}>
        <Quote name="Katharine Viner" jobTitle="Editor-in-chief" headshot={// No alt text needed- the accompanying name/job title describe the image
