	...
	return (
		<FlexContainer cssOverrides={evFlexContainer}>
			<div css={evHeadlineContainer}>
				...
				<h2 css={evHeadline}>Why your support matters</h2>
				<HeadlineSvg />
			</div>
			<div css={evQuoteContainer}>
				<Quote
					...
					headshot={
						...
						<img
							src="https://media.guim.co.uk/1e8cd6f3fc9af8ba9f84a4f70acc381ca9bf0fb3/0_0_315_315/140.png"
							alt=""
						/>
					}
				>
					<p>
						...
						investigate, explain, challenge, expose, amplify the voices that
