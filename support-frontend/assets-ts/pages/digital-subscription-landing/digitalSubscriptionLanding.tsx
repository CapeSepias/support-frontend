...
import { AUDCountries, Canada, CountryGroupId, detect, EURCountries, GBPCountries, International, NZDCountries, UnitedStates } from "helpers/internationalisation/countryGroup";
...
import digitalSubscriptionLandingReducer, { State } from "./digitalSubscriptionLandingReducer";
...
function LandingPage() {
  ...
  return <Page header={<CountrySwitcherHeader />} footer={footer}>
      {orderIsAGift ? <HeroWithImage countryGroupId={countryGroupId} promotionCopy={sanitisedPromoCopy} /> : <HeroWithPriceCards promotionCopy={sanitisedPromoCopy} countryGroupId={countryGroupId} priceList={heroPriceList} />}
      <FullWidthContainer>
        <CentredContainer>
      ...
      {showEditorialVoiceComponent && <FullWidthContainer cssOverrides={evContainerOverrides}>
          <CentredContainer>
            <EditorialVoice />
          </CentredContainer>
        </FullWidthContainer>}
