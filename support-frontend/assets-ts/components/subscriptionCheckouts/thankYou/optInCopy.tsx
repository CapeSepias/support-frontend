...
function OptInCopy(props: PropTypes) {
	...
	return (
		<Text>
			...
			{props.subscriptionProduct !== GuardianWeekly && 'dedicated'} weekly email
			from our {props.subscriptionProduct !== GuardianWeekly && 'membership'}{' '}
			editor and get more information on ways to support The Guardian.
		</Text>
	);
} // ----- Exports ----- //
