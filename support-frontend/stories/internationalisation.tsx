...
stories.add('Country Group Switcher', () => {
  ...
  return <div style={{
    ...
    color: '#ffffff'
      ...
      <CountryGroupSwitcher countryGroupIds={[GBPCountries, UnitedStates, AUDCountries, EURCountries, NZDCountries, Canada, International]} selectedCountryGroup={countryGroup} onCountryGroupSelect={() => {}} subPath={window.location.search} />
    </div>;
});