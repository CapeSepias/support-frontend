...
import { RegularPaymentRequestAddress } from 'helpers/paymentIntegrations/readerRevenueApis';
import 'helpers/paymentIntegrations/readerRevenueApis';
import { Scoped } from 'helpers/scoped';
import 'helpers/scoped';
...
// ----- Action Creators ----- //
const setFormErrorsFor = (scope: AddressType) => (
