...
function getParticipations(
  ...
  const acquisitionDataTest:
    | AcquisitionABTest
    | null
    | undefined = getTestFromAcquisitionData();
...
const init = (
  ...
  const urlParticipations:
    | Participations
    | null
    | undefined = getParticipationsFromUrl();
  const serverSideParticipations:
    | Participations
    | null
    | undefined = getServerSideParticipations();
  const amountsTestParticipations:
    | Participations
    | null
    | undefined = getAmountsTestParticipations(countryGroupId, settings);
  return {
    ...participations,
