...
import { ThirdPartyPaymentLibrary } from 'helpers/checkouts';
import 'helpers/checkouts';
...
import { StripeAccount } from 'helpers/stripe';
...
const setAmazonPayPaymentSelected = (paymentSelected: boolean) => (
  dispatch: (...args: Array<any>) => any,
): void => {
  dispatch(
    setFormSubmissionDependentValue(() => ({
...
const setAmazonPayOrderReferenceId = (orderReferenceId: string) => (
  dispatch: (...args: Array<any>) => any,
): void => {
  dispatch(
    setFormSubmissionDependentValue(() => ({
...
const setAmazonPayBillingAgreementId = (amazonBillingAgreementId: string) => (
  dispatch: (...args: Array<any>) => any,
): void => {
  dispatch(
    setFormSubmissionDependentValue(() => ({
...
const loadPayPalExpressSdk = (contributionType: ContributionType) => (
  dispatch: (...args: Array<any>) => any,
): void => {
