...
export const ContentVoucherFaqBlock = () => (
  ...
  >
    <Text>
      Pick your subscription package below. We’ll send you a book of vouchers
      that contain one voucher per paper in your subscription.
    </Text>
    <Text>
      Take your voucher to your retailer. Your vouchers will be accepted at
      retailers across the UK, including most independent newsagents.
    </Text>
    <Text>
        ...
        <Accordion>
          <AccordionRow label="Voucher details">
            ...
            <p>
              ...
              you’re going on holiday, you won’t have to pay for the papers
              you’ll miss.
            </p>
          </AccordionRow>
        </Accordion>
