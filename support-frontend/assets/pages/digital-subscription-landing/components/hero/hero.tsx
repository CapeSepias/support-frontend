...
const HeroCopy = () => (
  <>
    ...
    <p>
      Plus, for a limited time, you can read our latest special edition - The
      books of&nbsp;2021.
    </p>
  </>
);
...
const HeroCopyAus = () => (
  <>
    <p>
      ...
      you the richest experience of Guardian Australia journalism. It also
      sustains the independent reporting you love.
    </p>
    <p>
      You&apos;ll gain exclusive access to <strong>Australia Weekend</strong>,
      the new digital edition, providing you with a curated view of the
      week&apos;s biggest stories, plus early access to essential weekend news.
    </p>
  </>
);
...
function DigitalHero({
  ...
  const roundelText =
    promotionHTML(promotionCopy.roundel, {
  ...
  return (
    <PageTitle
      title={
        orderIsAGift ? 'Give the digital subscription' : 'Digital subscription'
      }
      theme="digital"
    >
      <CentredContainer>
          ...
          image={
            showPriceCards ? (
              <HeroPriceCards
                ...
                roundel={
                  <HeroRoundel
                    cssOverrides={testEmbeddedRoundel}
                    theme="digital"
                  >
                    {roundelText}
                  </HeroRoundel>
